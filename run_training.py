...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, mirror_augment_v, augmentations, metrics, min_h, min_w, res_log2, lr, cond, resume_pkl, resume_kimg):
    ...
    os.environ['BATCH_PER'] = f"{sched.minibatch_gpu_base}"
...
def main():
    ...
    parser.add_argument('--augmentations', help='Add random spatial augmentations from Zhao et al 2020b (default: %(default)s)', default=False, metavar='BOOL', type=_str_to_bool)
