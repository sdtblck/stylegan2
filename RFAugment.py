...
def apply_zoom_in_tpu(x, alpha=alpha_default):
    ...
    min_val = 64 #TODO: shouldn't be hardcoded
    choice = tf.random_uniform([], min_val, h, tf.int32)
...
def experimental_transform(image):
...
SINGLE_IMG_FNS_TPU = {
    ...
    'experimentaltrans': [experimental_transform]
}
