...
colour_alpha_default = 0.05  # set default alpha for colour augmentations
...
# ----------------------------------------------------------------------------
# TF image rasterizer by Shawwn: https://github.com/shawwn/tfimg/blob/master/aug.py#L37
